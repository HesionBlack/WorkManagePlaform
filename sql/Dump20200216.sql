...
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler','LAPTOP-6RGHAD0S1582205172299',1582205340576,15000);
...
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler','TASK_CLASS_NAME1','DEFAULT','TASK_CLASS_NAME1','DEFAULT',NULL,1582205180000,-1,5,'PAUSED','CRON',1582205172000,0,NULL,2,''),('RuoyiScheduler','TASK_CLASS_NAME2','DEFAULT','TASK_CLASS_NAME2','DEFAULT',NULL,1582205175000,-1,5,'PAUSED','CRON',1582205172000,0,NULL,2,''),('RuoyiScheduler','TASK_CLASS_NAME3','DEFAULT','TASK_CLASS_NAME3','DEFAULT',NULL,1582205180000,-1,5,'PAUSED','CRON',1582205172000,0,NULL,2,'');
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=195 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user_online` VALUES ('1e885d63-4862-4302-8795-5c6b74364c1a','admin','研发部门','127.0.0.1','内网IP','Chrome 8','Windows 10','on_line','2020-02-20 21:11:59','2020-02-20 21:26:18',1800000),('a6b2e65b-e652-44ad-b0bc-049966c52df5','admin','研发部门','127.0.0.1','内网IP','Chrome 8','Windows 10','on_line','2020-02-20 19:41:15','2020-02-20 21:01:45',1800000);
...
-- Dump completed on 2020-02-20 21:29:04
